...
from src.ddx_data_gen.prompts import PROMPT_TEMPLATES_GEN, PROMPT_TEMPLATES_EVAL_MERLIN, \
...
class PromptArgs:
    ...
    def set_verifier_args(
        ...
        self.pydantic_scheme = pydantic_scheme
